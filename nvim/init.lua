...
vim.keymap.set("n", "<C-j>", "<cmd>cnext<CR>", { desc = "jumping to next quickfix item" })
vim.keymap.set("n", "<C-k>", "<cmd>cprev<CR>", { desc = "jumping to previous quickfix item" })
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>s.", tele.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
			...
			--  See `:help telescope.tele.live_grep()` for information about particular keys
